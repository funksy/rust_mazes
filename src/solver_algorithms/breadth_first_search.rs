...
pub fn find_solution(maze: &Maze, start: &Coord, finish: &Coord) {
...
fn add_adjacent_cells(maze: &Maze, explored: &mut HashMap<Coord, Coord>, frontier: &mut VecDeque<Coord>, current_cell: &Coord) {
